...
import auca.com.demo.service.SemesterService;
import java.rmi.RemoteException;
import java.util.List;

@RestController
@RequestMapping(value = "/semesterss/",consumes = {MediaType.APPLICATION_JSON_VALUE},
...
public class SemesterController {
    ...
    public ResponseEntity<?> updateSemester(@PathVariable("id") Integer id, @RequestBody Semester updatedSemester) {
        try {
            Semester existingSemester = semesterService.selectSemester(id);
            ...
            if (existingSemester != null) {
                ...
                Semester updatedSemesterEntity = semesterService.insertSemester(existingSemester);

                if (updatedSemesterEntity != null) {
